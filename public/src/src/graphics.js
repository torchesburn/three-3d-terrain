...
export const graphics = (function() {
  ...
  class _Graphics {
    //--------------------------------
    constructor({ targetElementId = 'target', graphics = DEFAULT_GRAPHIC_OPTIONS } = {}) {
      graphics = Object.assign(DEFAULT_GRAPHIC_OPTIONS, graphics);
    ...
    //--------------------------------
    Initialize() {
      console.log('[graphics][Initialize]', this.options);
    ...
    //--------------------------------
    _CreateLights() {
      let light = new THREE.DirectionalLight(0xFFEEEE, 1);        
